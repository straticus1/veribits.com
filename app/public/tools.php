        ...
        <div class="container">
            ...
            <div class="tools-grid">
                <div class="tool-card" onclick="window.location='/tools/file-magic'">
                    ...
                    <a href="/tools/file-magic" class="btn btn-primary" style="margin-top: 1rem;">Launch Tool →</a>
                </div>

                <div class="tool-card" onclick="window.location='/tools/file-signature'">
                    ...
                    <a href="/tools/file-signature" class="btn btn-primary" style="margin-top: 1rem;">Launch Tool →</a>
                </div>

                <div class="tool-card" onclick="window.location='/tools/email-verification'">
                    <div class="feature-icon">📧</div>
                    ...
                    <a href="/tools/email-verification" class="btn btn-primary" style="margin-top: 1rem;">Launch Tool →</a>
                </div>

                <div class="tool-card" onclick="window.location='/tools/ssl-chain-resolver'">
                    <div class="feature-icon">🔐</div>
                    <h3>SSL Chain Resolver</h3>
                    <p>Automatically build and validate complete SSL/TLS certificate chains with verification.</p>
                    <a href="/tools/ssl-chain-resolver" class="btn btn-primary" style="margin-top: 1rem;">Launch Tool →</a>
                </div>

                <div class="tool-card" onclick="window.location='/tools/stego'">
                    <div class="feature-icon">🎭</div>
                    <h3>Steganography Detector</h3>
                    <p>Detect hidden data in images and files. Identify potential steganographic content.</p>
                    <a href="/tools/stego" class="btn btn-primary" style="margin-top: 1rem;">Launch Tool →</a>
                </div>

                <div class="tool-card" onclick="window.location='/tools/pgp'">
                    <div class="feature-icon">🔑</div>
                    <h3>PGP Key Validator</h3>
                    <p>Validate PGP public keys, check expiration dates, and verify key fingerprints.</p>
                    <a href="/tools/pgp" class="btn btn-primary" style="margin-top: 1rem;">Launch Tool →</a>
                </div>

                <div class="tool-card" onclick="window.location='/tools/dns'">
                    <div class="feature-icon">🌐</div>
                    <h3>DNS Validator</h3>
                    <p>Validate DNS records, check DNSSEC, and analyze domain configurations.</p>
                    <a href="/tools/dns" class="btn btn-primary" style="margin-top: 1rem;">Launch Tool →</a>
                </div>

                <div class="tool-card" onclick="window.location='/tools/ip-calculator'">
                    <div class="feature-icon">🔢</div>
                    <h3>IP Calculator</h3>
                    <p>Calculate IP subnets, CIDR notation, and network ranges.</p>
                    <a href="/tools/ip-calculator" class="btn btn-primary" style="margin-top: 1rem;">Launch Tool →</a>
                </div>

                <div class="tool-card" onclick="window.location='/tools/breach-check'">
                    <div class="feature-icon">🔍</div>
                    <h3>Data Breach Checker</h3>
                    <p>Check if your email or password has been compromised in known data breaches.</p>
                    <a href="/tools/breach-check" class="btn btn-primary" style="margin-top: 1rem;">Launch Tool →</a>
                </div>

                <div class="tool-card" onclick="window.location='/tools/cloud-storage-auditor'">
                    <div class="feature-icon">☁️</div>
                    <h3>Cloud Storage Auditor</h3>
                    <p>Audit AWS S3 and Azure Blob storage for security misconfigurations and public access.</p>
                    <a href="/tools/cloud-storage-auditor" class="btn btn-primary" style="margin-top: 1rem;">Launch Tool →</a>
                </div>

                <div class="tool-card" onclick="window.location='/tools/base64'">
                    <div class="feature-icon">📝</div>
                    <h3>Base64 Encoder/Decoder</h3>
                    <p>Encode and decode Base64 data for various applications and protocols.</p>
                    <a href="/tools/base64" class="btn btn-primary" style="margin-top: 1rem;">Launch Tool →</a>
                </div>
            </div>
            ...
            <div class="tools-grid">
                <div class="tool-card">
                    ...
                    <span class="btn btn-secondary" style="margin-top: 1rem; cursor: not-allowed;">Coming Soon</span>
                </div>
                ...
                <div class="tool-card">
                    ...
                    <p>Scan code for exposed API keys, tokens, passwords, and sensitive credentials.</p>
                    <span class="btn btn-secondary" style="margin-top: 1rem; cursor: not-allowed;">Coming Soon</span>
                </div>
